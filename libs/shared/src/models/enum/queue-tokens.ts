...
export const enum EVENT_COMMANDS {
  ...
  SUBSCRIPTION_GET_COUNT = 'subscription_get_count',
}
...
export const SUBSCRIPTION_GET = EVENT_COMMANDS.SUBSCRIPTION_GET;
export const SUBSCRIPTION_GET_COUNT = EVENT_COMMANDS.SUBSCRIPTION_GET_COUNT;
